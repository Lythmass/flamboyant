...
export default function Main() {
  return (
    <main className='w-full h-full overflow-y-auto overflow-x-hidden scroll-smooth'>
      ...
      <Services />
      <Contact />
      <footer className='w-full h-[15rem] lg:h-[9rem] lg:px-10 gap-4 flex-col lg:flex-row bg-dark p-7 flex justify-start lg:justify-between items-start lg:items-center'>
        <h1
