...
export const NavBar = () => {
  ...
  return (
    <div className='z-[100] w-full left-[-100%] md:left-0 absolute md:relative md:w-[var(--navbar-length)] bg-light border-r-2 border-dark h-full flex items-center flex-col py-32 gap-20'>
