...
export const AboutExperience = () => {
  ...
  return (
    <motion.div
      ...
      className='w-full relative flex flex-col xl:flex-row gap-4 justify-around p-3 xl:px-10 xl:py-7 xl:min-h-[18rem] 2xl:h-[18rem] bg-dark shadow-[0.8rem_0.8rem_var(--accent-2)] '
    >
